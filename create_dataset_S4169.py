...
class AA_Dataset_con(Dataset):
    ...
    def raw_file_names(self):
        ...
        return ['names_1_4169.npy', 'targets_1_4169.npy',\
                'edge_indexes_WT_1_4169.npy', 'center_pls_WT_1_4169.npy', \
                'features_prot5_WT_1_4169.npy','features_dssp_WT_1_4169.npy',\
                'features_pssm_WT_1_4169.npy']
    ...
    def get(self, idx):
        ...
        if self.test:
            ...
            data = torch.load(os.path.join(self.processed_dir, 
                                 f'data_{idx}.pt'))   
        return data
#dataset = AA_Dataset_con(root = 'data_1217/data_per_mutation_con/')
...
class AA_Dataset_MT(Dataset):
    ...
    def raw_file_names(self):
        ...
        return ['names_1_4169.npy', 'targets_1_4169.npy',\
                'edge_indexes_MT_1_4169.npy', 'center_pls_MT_1_4169.npy', \
                'features_prot5_MT_1_4169.npy']
