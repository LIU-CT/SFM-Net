...
class SFM_Net(torch.nn.Module):
    def __init__(self):
        ...
        print(f'SFM_Net, dropout:{dropout}, dropout_heavy:{dropout_heavy}')
...
class SFM_Netablastu01(torch.nn.Module):
    def __init__(self):
        ...
        print(f'SFM_Netablastu01, dropout:{dropout}, dropout_heavy:{dropout_heavy}')
        self.dropout_in = nn.Dropout(0.)
...
class SFM_Netablastu02(torch.nn.Module):
    def __init__(self):
        ...
        print(f'SFM_Netablastu02, dropout:{dropout}, dropout_heavy:{dropout_heavy}')
        self.dropout_in = nn.Dropout(0.)
...
class SFM_Netablastu02v1(torch.nn.Module):
    def __init__(self):
        ...
        print(f'SFM_Netablastu02v1, dropout:{dropout}, dropout_heavy:{dropout_heavy}')
        self.dropout_in = nn.Dropout(0.)
...
class SFM_Netablastu02v2(torch.nn.Module):
    def __init__(self):
        ...
        print(f'SFM_Netablastu02v2, dropout:{dropout}, dropout_heavy:{dropout_heavy}')
        self.dropout_in = nn.Dropout(0.)
...
# SFM_Netablastu03v1 prot5&pssm without dssp 
######################################################
class SFM_Netablastu03v1(torch.nn.Module): #以下修改中
    def __init__(self):
        ...
        print(f'SFM_Netablastu03v1, dropout:{dropout}, dropout_heavy:{dropout_heavy}')
        self.dropout_in = nn.Dropout(0.)
...
class SFM_Netablastu03v2(torch.nn.Module):
    def __init__(self):
        ...
        print(f'SFM_Netablastu03v2, dropout:{dropout}, dropout_heavy:{dropout_heavy}')
        self.dropout_in = nn.Dropout(0.)
...
class SFM_Netablastu04 (torch.nn.Module):
    def __init__(self):
        ...
        print(f'SFM_Netablastu04, dropout:{dropout}, dropout_heavy:{dropout_heavy}')        
        self.dropout_in = nn.Dropout(0.)
...
class SFM_Netablastu05(torch.nn.Module):
    def __init__(self):
        ...
        print(f'SFM_Netablastu05, dropout:{dropout}, dropout_heavy:{dropout_heavy}')
        self.dropout_in = nn.Dropout(0.)
